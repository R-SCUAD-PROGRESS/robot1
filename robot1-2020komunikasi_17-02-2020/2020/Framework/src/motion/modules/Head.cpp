...
Head::Head()
{
	...
	m_LeftLimit = 70;
	m_RightLimit = -70;
	m_TopLimit = Kinematics::EYE_TILT_OFFSET_ANGLE ;//- 5;
	m_BottomLimit = Kinematics::EYE_TILT_OFFSET_ANGLE - 90;//- 65;

	m_Pan_Home = 0.0;
	//m_Tilt_Home = Kinematics::EYE_TILT_OFFSET_ANGLE ;nilai awal
m_Tilt_Home = Kinematics::EYE_TILT_OFFSET_ANGLE - 35;//35;//20;
