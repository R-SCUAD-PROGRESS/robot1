...
int H_MIN = 8;//0;//16;//9;//16;//0
int H_MAX = 41;//256;//71;//47;//71;//256
int S_MIN = 188;//0;//146;//0
int S_MAX = 256;//23;//184;//23;//256
int V_MIN = 159;//0;//232;//226;//232;//0
int V_MAX = 256;//256
        ...
        if(numObjects<MAX_NUM_OBJECTS){
            for (int index = 0; index >= 0; index = hierarchy[index][0]) {
                ...
                if(area>MIN_OBJECT_AREA && area<MAX_OBJECT_AREA && area>refArea)
				{
					...
					offset.X *= ((160 / 150)*0.2); // pixel per angle
					offset.Y *= ((240 / 150)*0.2); // pixel per angle
