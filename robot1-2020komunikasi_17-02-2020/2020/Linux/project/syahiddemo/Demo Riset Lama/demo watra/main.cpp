...
//cvNamedWindow( "After Color Filtering", (320,240));
...
CvSize size = cvSize(640,480);
    ...
    while(1)
    {
       ...
       hsv_min = cvScalar(16, 0, 232, 0);		// orange (10, 199, 158, 0)
       hsv_max = cvScalar(71, 23, 256, 0);		// orange (26, 256, 256, 0)
...
// Filter out colors which are out of range.
	...
	CvMemStorage* storage = cvCreateMemStorage(0);
        ...
        CvSeq* circles = cvHoughCircles(thresholded, storage, CV_HOUGH_GRADIENT, 2,
                                        thresholded->height/4, 100, 50, 1, 55);  ///4, 100, 50, 10, 70)
...
Action::GetInstance()->m_Joint.SetEnableBody(false);
	...
	else
	{
		...
		//offset.X *= ((240 / 150)*0.2); // pixel per angle
		//offset.Y *= ((320 / 150)*0.2); // pixel per angle
